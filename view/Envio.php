    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="list-group">
                    ...
                    <a href="../controller/mainEnvioController.php" class="list-group-item list-group-item-action active">ENVÍOS</a>
            ...
            <div class="col-md-9">
                <div class="d-flex justify-content-between mb-3">
                    <a href="http://floristeria.kesug.com/view/crearEnvio.php" class="btn btn-warning">Crear Envio</a>
                </div>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php foreach ($envio as $envio): ?>
                            <tr>
                                <td>#00<?php echo $envio["id_pedido"] ?></td>
                                <td><?php echo $envio["direccion_envio"] ?></td>
                                <td><?php echo $envio["fecha_envio"] ?></td>
                                <td><?php echo $envio["estado_envio"] ?></td>
                                <td><a href="../controller/obtenerEnvioController.php?id_envio=<?php echo $envio['id_envio'] ?>" class="btn btn-info"><i class="fas fa-edit"></i></a></td>
                                <td><a href="../controller/eliminarEnvioController.php?id_envio=<?php echo $envio['id_envio'] ?>" class="btn btn-danger" onclick="return confirm('¿Desea eliminar este envio?')"><i class="fas fa-trash-alt"></i></a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
