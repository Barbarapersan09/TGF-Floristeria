    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="list-group">
                    ...
                    <a href="../controller/mainPagoController.php" class="list-group-item list-group-item-action active">PAGOS</a>
                    <a href="../controller/mainUsuarioController.php" class="list-group-item list-group-item-action">USUARIOS</a>
                </div>
            </div>
            <!-- Main Content -->
             <?php if(!$pago || empty($pago)): ?>
                <div class="col-md-9">
                    <p>No hay pagos.</p>
                </div>
            <?php else: ?>
                    ...
                    <tbody>
                        <?php foreach ($pago as $pago): ?>
                            <tr>
                                ...
                                <td><a href="../controller/obtenerPagoController.php?id_pago=<?php echo $pago['id_pago'] ?>" class="btn btn-info"><i class="fas fa-edit"></i></a></td>
                                <td><a href="../controller/eliminarPagoController.php?id_pago=<?php echo $pago['id_pago'] ?>" class="btn btn-danger" onclick="return confirm('¿Desea eliminar este pago?')"><i class="fas fa-trash-alt"></i></a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
