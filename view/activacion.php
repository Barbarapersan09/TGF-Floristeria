			...
			<div class="row justify-content-center">
				<div class="col-lg-8 text-center">
					<div class="section-title">
						<h3>Activación <span class="orange-text">Cuenta</span></h3>
					</div>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-lg-8 text-center">
					<div class="contact-form">
						...
						<?php endif; ?>
						<form method="POST" id="fruitkha-contact" action="../controller/verificarController.php">
							<p>
								<input type="text" placeholder="Codigo" name="hash" id="hash">
							</p>

							<p><input type="submit" value="Activar cuenta" class="btn btn-primary"></p>
						</form>
					</div>
				</div>
			</div>
