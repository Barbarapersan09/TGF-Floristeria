...
<body>
	...
	<div class="container mt-3">
		<form action="../controller/crearCategoriaController.php" method="POST" enctype="multipart/form-data">
			<div class="mb-3">
			...
			<button class="btn btn-secondary" type="submit">Crear Categoria</button>
		</form>
		<br>
	</div>
