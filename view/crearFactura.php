...
require_once "../controller/obtenerPedidosNoFacturadosController.php";
...
<body>
	...
	<div class="container mt-3">
		<form action="../controller/crearFacturaController.php" method="POST" enctype="multipart/form-data">
			<div class="mb-3">
			...
			<div class="mb-3">
				...
				<input class="form-control" type="text" name="monto_total" required>
			</div>

			<button class="btn btn-secondary" type="submit">Crear Factura</button>
		</form>
		<br>
	</div>
