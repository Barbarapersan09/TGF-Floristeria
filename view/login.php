			...
			<div class="row justify-content-center">
				<div class="col-lg-8 text-center">
					<div class="section-title">
						<h3>Iniciar <span class="orange-text">Sesión</span></h3>
						<p>¿No tienes cuenta aqui?<a href="../view/registro.php"> Crear una cuenta </a></p>
					</div>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-lg-8 text-center">
					<div class="contact-form">
						...
						<form method="POST" id="fruitkha-contact" action="../controller/LoginController.php">
							<p>
							...
							<p><input type="submit" value="Iniciar Sesión" class="btn btn-primary"></p>
							<div class="section-title">
								<p>¿Has olvidado la contraseña?<a href="cambiarPass.php"> Cambiar contraseña </a></p>
							</div>
						</form>
					</div>
				</div>
