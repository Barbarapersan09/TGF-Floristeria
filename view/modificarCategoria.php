...
<body>
	...
	<div class="container mt-3">
		<form action="../controller/modificarCategoriaController.php" method="POST" enctype="multipart/form-data">
			<div class="mb-3">
				<input type="hidden" name="id_categoria" value="<?php echo $categoria['id_categoria'] ?>">
				<label for="nombre">Nombre de la categoria</label>
				<input class="form-control" type="text" name="nombre_categoria" value="<?php echo $categoria['nombre_categoria'] ?>">
			</div>
			<div class="mb-3">
				<label for="descripcion">Descripcion del producto</label>
				<input class="form-control" type="text" name="descripcion" value="<?php echo $categoria['descripcion'] ?>">
			</div>
