...
<body>
	...
	<div class="container mt-3">
		<form action="../controller/modificarEnvioController.php" method="POST" enctype="multipart/form-data">
			<div class="mb-3">
				<input type="hidden" name="id_envio" value="<?php echo $envio['id_envio'] ?>">
				<label for="nombre">Numero de Pedido</label>
				<input class="form-control" type="text" readonly name="id_pedido" value="<?php echo $envio['id_pedido'] ?>">
			</div>
			<div class="mb-3">
				<label for="descripcion">Dirección de envio</label>
				<input class="form-control" type="text" name="direccion_envio" value="<?php echo $envio['direccion_envio'] ?>">
			</div>
			<div class="mb-3">
				<label for="descripcion">Fecha del envio</label>
				<input class="form-control" type="datetime-local" name="fecha_envio" value="<?php echo $envio['fecha_envio'] ?>">
			</div>
			<div class="mb-3">
				<label for="descripcion">Estado del envio</label>
				<select class="form-control" name="estado_envio">
					<option value="<?php echo $envio['estado_envio'] ?>"><?php echo $envio['estado_envio'] ?></option>
			...
			<button class="btn btn-secondary" type="submit">Actualizar Envio</button>
		</form>
		<br>
	</div>
