...
<body>
	...
	<div class="container mt-3">
		<form action="../controller/modificarFacturaController.php" method="POST" enctype="multipart/form-data">
			<div class="mb-3">
				<label for="nombre">Numero de Pedido</label>
				<input class="form-control" type="text" readonly name="id_pedido" value="<?php echo $factura['id_pedido'] ?>">
			</div>
			<div class="mb-3">
				<label for="nombre">Numero de Factura</label>
				<input class="form-control" type="text" readonly name="id_factura" value="<?php echo $factura['id_factura'] ?>">
			</div>
			<div class="mb-3">
				<label for="descripcion">Fecha del envio</label>
				<input class="form-control" type="datetime-local" name="fecha_factura" value="<?php echo $factura['fecha_factura'] ?>">
			</div>
			<div class="mb-3">
				<label for="descripcion">Monto Total</label>
				<input class="form-control" type="text" name="monto_total" value="<?php echo $factura['monto_total'] ?>">
			</div>

			<button class="btn btn-secondary" type="submit">Actualizar Factura</button>
		</form>
		<br>
	</div>
