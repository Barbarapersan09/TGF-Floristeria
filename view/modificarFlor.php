...
<body>
	...
	<div class="container mt-3">
		<form action="../controller/modificarFlorController.php" method="POST" enctype="multipart/form-data">
			<div class="mb-3">
				<input type="hidden" name="id_flor" value="<?php echo $flor['id_flor'] ?>">
				<label for="nombre">Nombre del producto</label>
				<input class="form-control" type="text" name="nombre" value="<?php echo $flor['nombre'] ?>">
			</div>
			<div class="mb-3">
				<label for="descripcion">Descripcion del producto</label>
				<input class="form-control" type="text" name="descripcion" value="<?php echo $flor['descripcion'] ?>">
			</div>
			<div class="mb-3">
				<label for="precio">Precio del producto</label>
				<input class="form-control" type="number" name="precio" value="<?php echo $flor['precio'] ?>">
			</div>
			<div class="mb-3">
				<input type="hidden" name="url_imagen" value="<?php echo $flor['url_imagen'] ?>">
				<img style="width: 100px;" src="<?php echo $flor['url_imagen'] ?>" alt="">
				<input class="form-control" type="file" name="url_imagen" value="<?php echo $flor['url_imagen'] ?>">
			</div>
			<div class="mb-3">
				<label for="color">Color del producto</label>
				<select class="form-control" name="color" id="color-filter">
					<option value="<?php echo $flor['color'] ?>"><?php echo $flor['color'] ?></option>
			...
			<div class="mb-3">
				...
				<select class="form-control" name="ocasion" id="ocasion-filter">
					<option value="<?php echo $flor['ocasion'] ?>"><?php echo $flor['ocasion'] ?></option>
			...
			<div class="mb-3">
				...
				<input class="form-control" type="number" name="stock" value="<?php echo $flor['stock'] ?>">
			</div>
			<div class="mb-3">
			...
			<button class="btn btn-secondary" type="submit">Actualizar producto</button>
		</form>
		<br>
	</div>
