...
<body>
	...
	<div class="container mt-3">
		<form action="../controller/modificarPagoController.php" method="POST" enctype="multipart/form-data">
			<div class="mb-3">
				<input type="hidden" name="id_pago" value="<?php echo $_GET['id_pago'] ?>">
				<input type="hidden" name="id_pedido" value="<?php echo $pago['id_pedido'] ?>">
				<input type="hidden" name="id_usuario" value="<?php echo $pago['id_usuario'] ?>">
				<label for="id_pedido">Numero de Pedido</label>
				<input class="form-control" type="text" readonly name="id_pedido" value="<?php echo $pago['id_pedido'] ?>">
			</div>
			<div class="mb-3">
				<input type="hidden" name="id_usuario" value="<?php echo $pago['id_usuario'] ?>">
				<label for="id_usuario">ID Usuario</label>
				<input class="form-control" type="text" readonly name="id_usuario" value="<?php echo $pago['id_usuario'] ?>">
			</div>
			<div class="mb-3">
				<label for="metodo_pago">Metodo de Pago</label>
				<select class="form-control" name="metodo_pago">
					<option value="<?php echo $pago['metodo_pago'] ?>"><?php echo $pago['metodo_pago'] ?></option>
			...
			<div class="mb-3">
				...
				<input class="form-control" type="text" name="monto" value="<?php echo $pago['monto'] ?>">
			</div>
			<div class="mb-3">
				<input type="hidden" name="id_usuario" value="<?php echo $pago['id_usuario'] ?>">
				<label for="fecha_pago">Fecha de Pago</label>
				<input class="form-control" type="text" readonly name="fecha_pago" value="<?php echo $pago['fecha_pago'] ?>">
			</div>
			<div class="mb-3">
				<label for="estado_pago">Estado de Pago</label>
				<select class="form-control" name="estado_pago">
					<option value="<?php echo $pago['estado_pago'] ?>"><?php echo $pago['estado_pago'] ?></option>
			...
			<button class="btn btn-secondary" type="submit">Actualizar Categoria</button>
		</form>
		<br>
	</div>
