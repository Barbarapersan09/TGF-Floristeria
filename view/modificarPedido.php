...
<body>
	...
	<div class="container mt-3">
		<form action="../controller/modificarPedidoController.php" method="POST" enctype="multipart/form-data">
			<div class="mb-3">
				<input type="hidden" name="id_pedido" value="<?php echo $pedido['id_pedido'] ?>">
				<input type="hidden" name="id_usuario" value="<?php echo $pedido['id_usuario'] ?>">
				<label for="nombre">Numero de Pedido</label>
				<input class="form-control" type="text" readonly name="id_pedido" value="<?php echo $pedido['id_pedido'] ?>">
			</div>
			<div class="mb-3">
				<label for="monto_total">Monto Total</label>
				<input class="form-control" type="text" name="monto_total" value="<?php echo $pedido['monto_total'] ?>">
			</div>
			<div class="mb-3">
				<label for="estado_pedido">Estado del Pedido</label>
				<select class="form-control" name="estado_pedido">
					<option value="<?php echo $pedido['estado_pedido'] ?>"><?php echo $pedido['estado_pedido'] ?></option>
			...
			<button class="btn btn-secondary" type="submit">Actualizar Pedido</button>
		</form>
		<br>
	</div>
