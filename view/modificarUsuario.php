...
<body>
    ...
    <div class="container mt-3">
        <form action="../controller/modificarUsuarioController.php" method="POST" enctype="multipart/form-data">
            <div class="mb-3"> 
                <input type="hidden" name="id_usuario" value="<?php echo $usuario['id_usuario'] ?>">
                <input type="hidden" name="hash" value="<?php echo $usuario['hash'] ?>">
            ...
            <button class="btn btn-secondary" type="submit">Actualizar Usuario</button>
        </form>
		<br>
    </div>
