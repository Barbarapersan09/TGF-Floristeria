    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="list-group">
                    <a href="../controller/mainFlorController.php" class="list-group-item list-group-item-action active ">FLORES</a>
            ...
            <div class="col-md-9">
                <div class="d-flex justify-content-between mb-3">
                    <a href="http://floristeria.kesug.com/view/crearFlor.php" class="btn btn-warning">Crear Producto</a>
                </div>
                    ...
                    <tbody>
                        <?php foreach ($flores as $flor): ?>
                            <tr>
                                ...
                                <td><?php echo $flor["stock"] ?></td>
                                <td><a href="../controller/obtenerFlorController.php?id_flor=<?php echo $flor['id_flor'] ?>" class="btn btn-info"><i class="fas fa-edit"></i></a></td>
                                <td><a href="../controller/eliminarFlorController.php?id_flor=<?php echo $flor['id_flor'] ?>" class="btn btn-danger" onclick="return confirm('¿Desea eliminar el producto?')"><i class="fas fa-trash-alt"></i></a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
