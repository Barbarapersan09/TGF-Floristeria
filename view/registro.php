<?php 
	...
	if(isset($_SESSION["id"])){
		header("Location: ../controller/mainFlorController.php");
	}
?>
						...
						<nav class="main-menu">
							<ul>
								...
								<li>
									...
									<?php endif; ?>
								</li>								<li><a href="../view/about.php">Sobre nosotros</a></li>
			...
			<div class="row justify-content-center">
				<div class="col-lg-8 text-center">
					<div class="section-title">
						<h3>Crear <span class="orange-text">Cuenta</span></h3>
						<p>¿Ya tienes cuenta aqui?<a href="../view/login.php"> Inicia Sesión </a></p>
					</div>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-lg-8 text-center">
					<div class="contact-form">
						<form method="POST" action="../controller/registroController.php" id="fruitkha-contact" >
							<p>
								<input type="text" placeholder="Nombre" name="nombre" id="name">
							</p>
							<p>
								<input type="text" placeholder="Apellido" name="apellido" id="name">
							</p>
							<p>
							...
							<p><input type="submit" value="Crear cuenta" class="btn btn-primary"></p>
						</form>
					</div>
				</div>
			</div>
